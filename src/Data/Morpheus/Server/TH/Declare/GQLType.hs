...
dropNamespaceOptions KindEnum tName opt = opt {fieldLabelModifier = stripConstructorNamespace tName}
dropNamespaceOptions _ tName opt = opt {constructorTagModifier = stripFieldNamespace tName}
