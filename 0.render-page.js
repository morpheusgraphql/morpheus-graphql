...
/* harmony import */ var _index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-b28ed814.js */ "./node_modules/@deckdeckgo/highlight-code/dist/esm/index-b28ed814.js");
...
const CarbonThemeStyle = ({ style }) => {
  return (Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("style", null, `
      :host ${style};
    `));
};
...
const DeckdeckgoHighlightCode = class {
  constructor(hostRef) {
    Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["r"])(this, hostRef);
    this.prismLanguageLoaded = Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "prismLanguageLoaded", 7);
    this.codeDidChange = Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "codeDidChange", 7);
    /**
  ...
  render() {
    ...
    return (Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: hostClass, onClick: () => this.edit() }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "container", ref: (el) => (this.refContainer = el) }, Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, contentEditable: this.editable, onBlur: async () => await this.applyCode(), onInput: () => this.inputCode(), onKeyDown: ($event) => this.catchTab($event), ref: (el) => (this.refCode = el) }), Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "code" }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== _deckdeckgo_highlight_code_languages_d1b78fa9_js__WEBPACK_IMPORTED_MODULE_1__["D"].CARBON) {
      return undefined;
    ...
    return [
      Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])(CarbonThemeStyle, { style: this.themeStyle }),
      Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green'))
    ];
  }
  renderCarbonCircle(color) {
    return Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: color });
  }
  renderUbuntu() {
    if (this.terminal !== _deckdeckgo_highlight_code_languages_d1b78fa9_js__WEBPACK_IMPORTED_MODULE_1__["D"].UBUNTU) {
      return undefined;
    }
    return (Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", null, Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "user" }))));
  }
  renderUbuntuCircle(mode) {
    const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
    return (Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: mode }, Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { innerHTML: symbol })));
  }
  get el() { return Object(_index_b28ed814_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
