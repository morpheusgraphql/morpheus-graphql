...
import Data.Morpheus.Types.Internal.Resolving (ResolverRootValue)
import qualified Data.Morpheus.Types.Internal.Resolving as R (ResolverRootValue (..))
...
instance Monad m => Stitching (ResolverRootValue e m) where
  stitch x y = do
