...
data JSType =  JSObject [(Text, JSType)] | JSList [JSType] |  JSEnum Text | JSInt Int | JSFloat Float | JSBool Bool | JSString Text | JSNull  deriving (Show, Generic)
...
decodeSciefintic v = case floatingOrInteger v of
