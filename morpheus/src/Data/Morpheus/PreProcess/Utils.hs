...
fieldTypeOf
    :: LineMarks -> Position -> GQL__Type -> Text -> Validation GQL__Type
fieldTypeOf lines pos _type fieldName =
...
typeBy lines pos typeLib _parentType _name =
    fieldTypeOf lines pos _parentType _name >>= fieldType
